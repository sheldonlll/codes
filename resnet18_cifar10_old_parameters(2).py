...
# 训练数据集
train_dataset = torchvision.datasets.CIFAR10(root=r'C:\\Users\\GM\Desktop\\liuzhengchang',train=True,download=True,transform=data_transform["train"])

# 测试数据集
test_dataset = torchvision.datasets.CIFAR10(root=r'C:\\Users\\GM\Desktop\\liuzhengchang',train=False,download=True,transform=data_transform["test"])
...
min_max_data_nums_per_class = [10, 3000]
